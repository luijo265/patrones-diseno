...
import comportamiento.mediator.module.*;
            ...
            public void run() {
                try {
                    ...
                    ModuleMessage stockEvent = new ModuleMessage(MODULE_NAME, 
                            ...
                            saleOrder);
                    mediator.mediate(stockEvent);
                    ModuleMessage sendProductEvent = new ModuleMessage(MODULE_NAME,
                            DistributionModule.MODULE_NAME,
                            DistributionModule.OPERATION_SEND_PRODUCTS,
                            saleOrder);
                    mediator.mediate(sendProductEvent);
